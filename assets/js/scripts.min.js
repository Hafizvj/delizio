...
if (function(a, e, s, n) {
        ...
        var M = function(e) {
                ...
                "initialized.owl.carousel refreshed.owl.carousel resized.owl.carousel": a.proxy(function(e) {
                    e.namespace && this._core.settings.scrollbarType && function(e) {
                        ...
                        this._core.$element.append(p), u.css({
                            ...
                            source: i
                        }, z), v = p.width(), k = e.item.count, S = e.page.size, j = v / (k - S + 1), L = this._core.options.smartSpeed, P.start = 0, P.cur = 0, "progress" === d.scrollbarType ? (p.prepend(h), y = B(e.item.index), t = u.width(), m.save.apply(g, C), h.width(y)) : (t = j, g.save.apply(g, C), u.width(t));
            ...
            }, r = this._core = e, this.options = a.extend(M.Defaults, this._core.options), this._core.$element.on(this._handlers), d = this.options
        };
    ...
    }(jQuery, window, document), function(P, R, I, e) {
        "use strict";
        var A = P(".pageloader");
        P("body").hasClass("active-pageloader") && A.length && P(R).on("load", function() {
            setTimeout(function() {
                A.removeClass("is-active")
            }, 500)
        }), P(I).ready(function() {
            var t, e = P(".current-year"),
                ...
                _ = new Date;
            if (e.length && e.text(_.getFullYear()), h.length && h.stickySidebar({
                    topSpacing: 100,
                    bottomSpacing: 100
                }), p.length && fitvids(".video-container"), c.length && (P(".docs-fixed").stickySidebar({
                    topSpacing: 100,
                    bottomSpacing: 100
                }), jQuery(function() {
                    var a = P(".docs-fixed-content"),
                        n = P(".docs-fixed ul li");
                    768 < jQuery(R).width() ? P(R).on("scroll", function() {
                    ...
                    P(".vertical-navigation-content.docs-fixed a").click(function() {
                        return P("html, body").animate({
                            scrollTop: P(P(this).attr("href")).offset().top - 90 + "px"
                        }, {
                            duration: 800
                        }), !1
                    })
            ...
            P(".floating_buttons").each(function() {
                ...
                P(e.target).closest(".quickview").length || P(e.target).closest(".show-quickview").length || !P(".quickview").hasClass("is-active") || P(e.target).closest(".floating_buttons").length || P(".quickview").removeClass("is-active")
            }), i.length && i.vidbacking({
                "youtube-mute-video": !1
            }), a.length && a.vidbacking(), d.length && d.parallax(), r.length && r.each(function() {
                P(this).find("> .delete").length && P(this).find("> .delete").on("click", function() {
                    P(this).parent().fadeOut()
                })
            }), s.length && s.each(function() {
                P(this).find(".message-header > .delete").length && P(this).find(".message-header > .delete").on("click", function() {
                ...
                P(e.target).closest(".dropdown").length || o.each(function() {
            ...
            function j(e) {
                v.addClass("overhang-push"), v.addClass("overhang-success"), v.removeClass("overhang-danger"), v.overhang(P.extend(S, {
                    message: g.html(),
                    callback: function(e) {
            ...
            function L(e) {
                v.addClass("overhang-push"), v.addClass("overhang-danger"), v.removeClass("overhang-success"), v.overhang(P.extend(S, {
                    message: m.html(),
                    callback: function(e) {
            ...
            f.length && f.submit(function(e) {
                e.preventDefault(), t = P(this).serialize(), P.ajax({
                    type: "POST",
                    url: f.attr("action"),
                    data: t,
                    dataType: "json"
            ...
            if (n.length && (A.removeClass("is-active"), n.each(function() {
                    var e = P(this);
                ...
                for (var O = 0; O < 15; O += 1) setTimeout(function e() {
                    var t = 1e3 * Math.random() + 5e3,
                        i = P("<div />", {
                            class: "smoke",
                            css: {
                                opacity: 0,
                                left: 200 * Math.random() + 80
                            }
                        });
                    P(i).appendTo("#viewport-food-smoke"), P.when(P(i).animate({
                        opacity: .8
                    }, {
                        duration: t / 4,
                        easing: "linear",
                        ...
                        bottom: P("#viewport-food-smoke").height()
                    }, {
                        duration: t,
                        easing: "linear",
                        queue: !1
            ...
            if (w.length)
                for (O = 0; O < 15; O += 1) setTimeout(function e() {
                    var t = 1e3 * Math.random() + 5e3,
                        i = P("<div />", {
                            class: "smoke",
                            css: {
                    ...
                    P(i).appendTo("#viewport-food-smoke-2"), P.when(P(i).animate({
                        opacity: .8
                    }, {
                        duration: t / 4,
                        easing: "linear",
                        ...
                        bottom: P("#viewport-food-smoke-2").height()
                    }, {
                        duration: t,
                        easing: "linear",
                        queue: !1
        ...
        j(O).ready(function() {
            ...
            function k() {
                var e = _.width();
                if (e < 1088) i.find("ul li").off("mouseenter mouseleave"), i.find("> ul > li > span").length || i.find("> ul > li:has( > ul)").prepend('<span class="main-parent"></span>'), i.find("> ul > li").each(function() {
        ...
        function a(e, y) {
            ...
            function p(e) {
                if (!0 !== o.data(Ie + "_intouch") && !(0 < oe(e.target).closest(y.excludedElements, o).length)) {
                    ...
                    return L = ke, n ? O = n.length : e.preventDefault(), S = _ = null, C = 1, k = T = x = b = w = 0, P = function() {
                        ...
                        return e
                    }(), (i = {})[le] = ae(le), i[de] = ae(de), i[ce] = ae(ce), i[ue] = ae(ue), j = i, J(), !n || O === y.fingers || y.fingers === Te || H() ? (ee(0, r), l = se(), 2 == O && (ee(1, n[1]), x = T = re(P[0].start, P[1].start)), (y.swipeStatus || y.pinchStatus) && (t = M(a, L))) : t = !1, !1 === t ? (M(a, L = Le), t) : (y.hold && (I = setTimeout(oe.proxy(function() {
                ...
                if (L !== je && L !== Le && !$()) {
                    ...
                    if (R = se(), f && (O = f.length), y.hold && clearTimeout(I), L = Se, 2 == O && (0 == x ? (ee(1, f[1]), x = T = re(P[0].start, P[1].start)) : (te(f[1]), T = re(P[0].end, P[1].end), P[0].end, P[1].end, S = C < 1 ? pe : he), C = (T / x * 1).toFixed(2), k = Math.abs(x - T)), O === y.fingers || y.fingers === Te || !f || H()) {
                        if (u = g.start, h = g.end, p = function(e, t) {
                            ...
                            }(e, _ = p <= 45 && 0 <= p ? le : p <= 360 && 315 <= p ? le : 135 <= p && p <= 225 ? de : 45 < p && p < 135 ? ue : ce), d = g.start, c = g.end, w = Math.round(Math.sqrt(Math.pow(c.x - d.x, 2) + Math.pow(c.y - d.y, 2))), b = ne(), o = _, l = w, l = Math.max(l, ie(o)), j[o].distance = l, (y.swipeStatus || y.pinchStatus) && (i = M(t, L)), !y.triggerOnTouchEnd || y.triggerOnTouchLeave) {
                            var m = !0;
            ...
            function g(e) {
                var t = e.originalEvent ? e.originalEvent : e,
                    i = t.touches;
                return i && i.length ? (d = se(), c = event.touches.length + 1, !0) : ($() && (O = c), R = se(), b = ne(), F() || !D() ? M(t, L = Le) : y.triggerOnTouchEnd || 0 == y.triggerOnTouchEnd && L === Se ? (e.preventDefault(), M(t, L = je)) : !y.triggerOnTouchEnd && U() ? z(t, L = je, ye) : L === Se && M(t, L = Le), K(!1), null)
            }
            ...
            function M(e, t) {
                var i, a = e.touches;
                return Y() || V() || W() || H() ? ((Y() || V()) && (i = z(e, t, me)), (W() || H()) && !1 !== i && (i = z(e, t, ve))) : Z() && G() && !1 !== i ? i = z(e, t, we) : b > y.longTapThreshold && w < Ce && y.longTap && !1 !== i ? i = z(e, t, _e) : 1 !== O && Oe || !(isNaN(w) || w < y.threshold) || !U() || !1 === i || (i = z(e, t, ye)), t === Le && m(), t === je && (a && a.length || m()), i
            }
        ...
        r._init = function() {
            ...
            if (this._time !== o || i) {
                if (!this._initted) {
                    ...
                    if (!i && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = o, this._rawPrevTime = d, z.push(this), void(this._lazy = [e, t]);
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(r, N) {
            ...
            var j, v, y, W, w, k, L, O, t, i, P = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                ne = function(e, t) {
                    ...
                    if (t = t || ee(e, null))
                        if (i = t.length)
                            for (; - 1 < --i;)(-1 === (n = t[i]).indexOf("-transform") || Me === n) && (r[n.replace(l, u)] = t.getPropertyValue(n));
                        else
            ...
            var ye = function(e, t, r, s) {
                ...
                Te = H.parseComplex = function(e, t, i, a, n, r, s, o, l, d) {
                    ...
                    var c, u, h, p, f, g, m, v, y, w, _, b, x, T = i.split(", ").join(",").split(" "),
                        ...
                        k = T.length,
                        S = !1 !== j;
                    for ((-1 !== a.indexOf(",") || -1 !== i.indexOf(",")) && (T = T.join(" ").replace(M, ", ").split(" "), C = C.join(" ").replace(M, ", ").split(" "), k = T.length), k !== C.length && (k = (T = (r || "").split(" ")).length), s.plugin = l, s.setRatio = d, c = ve.lastIndex = 0; c < k; c++)
            ...
            var Le, Oe, Pe, Re, Ie, Ae = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                We = (Ie = k || /Android/i.test(q) && !_gsScope.chrome, F.createElementNS && !Ie && (Oe = Ne("svg", He), Re = (Pe = Ne("rect", Oe, {
                    ...
                    height: 50,
                    x: 100
                })).getBoundingClientRect().width, Pe.style[ze] = "50% 50%", Pe.style[Qe] = "scaleX(0.5)", Ie = Re === Pe.getBoundingClientRect().width && !(W && De), He.removeChild(Oe)), Ie),
                ...
                qe = function(e, t) {
                    var i, a, n, r, s, o, l = e._gsTransform || new Fe,
                        d = e.style;
                    if (Qe ? a = te(e, Me, null, !0) : e.currentStyle && (a = (a = e.currentStyle.filter.match(h)) && 4 === a.length ? [a[0].substr(4), Number(a[2].substr(4)), Number(a[1].substr(4)), a[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), (i = !a || "none" === a || "matrix(1, 0, 0, 1, 0, 0)" === a) && Qe && ((o = "none" === ee(e).display) || !e.parentNode) && (o && (r = d.display, d.display = "block"), e.parentNode || (s = 1, He.appendChild(e)), i = !(a = te(e, Me, null, !0)) || "none" === a || "matrix(1, 0, 0, 1, 0, 0)" === a, r ? d.display = r : o && $e(d, "display"), s && He.removeChild(e)), (l.svg || e.getCTM && Ye(e)) && (i && -1 !== (d[Qe] + "").indexOf("matrix") && (a = d[Qe], i = 0), n = e.getAttribute("transform"), i && n && (-1 !== n.indexOf("matrix") ? (a = n, i = 0) : -1 !== n.indexOf("translate") && (a = "matrix(1,0,0,1," + n.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return Xe;
                    ...
                    if (c.svg = !(!e.getCTM || !Ye(e)), c.svg && (Be(e, te(e, ze, t, !1, "50% 50%") + "", c, e.getAttribute("data-svg-origin")), Le = H.useSVGTransformAttr || We), (n = qe(e)) !== Xe) {
                        if (16 === n.length) {
                            ...
                            var M = 6 <= n.length,
                                ...
                                F = n[2] || 0,
                                E = M ? n[3] : 1;
                            c.x = n[4] || 0, c.y = n[5] || 0, s = Math.sqrt(z * z + D * D), o = Math.sqrt(E * E + F * F), l = z || D ? Math.atan2(D, z) * V : c.rotation || 0, d = F || E ? Math.atan2(F, E) * V + l : c.skewX || 0, 90 < Math.abs(d) && Math.abs(d) < 270 && (u ? (s *= -1, d += l <= 0 ? 180 : -180, l += l <= 0 ? 180 : -180) : (o *= -1, d += d <= 0 ? 180 : -180)), c.scaleX = s, c.scaleY = o, c.rotation = l, c.skewX = d, De && (c.rotationX = c.rotationY = c.z = 0, c.perspective = p, c.scaleZ = 1), c.svg && (c.x -= c.xOrigin - (c.xOrigin * z + c.yOrigin * F), c.y -= c.yOrigin - (c.xOrigin * D + c.yOrigin * E))
                        }
            ...
            var et = function(e) {
                if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) n = !(s.cssText = "");
                        ...
                        for (a = (t = this.e.split(" ").join("").split(",")).length; - 1 < --a;) i = t[a], m[i] && (m[i].parse === o ? n = !0 : i = "transformOrigin" === i ? ze : m[i].p), $e(s, i);
            ...
            prepareSingleCaption: function(e) {
                ...
                if (void 0 !== i.blendmode && punchgs.TweenLite.set(i._pw, {
                    ...
                    punchgs.TweenLite.set(t, {
                        ...
                        y: parseInt(z + i._column.offset().top - t.offset().top, 0)
                    }), punchgs.TweenLite.set(t, {
                        y: M
                    })
                }
        ...
        var he = function(e, t, i, a) {
            ...
            d = function(a, e, x, t, i, n, r, s) {
                ...
                if (6 == a && (o.slots < 2 && (o.slots = 2), o.slots % 2 && (o.slots = o.slots + 1), _ = new punchgs.TimelineLite, setTimeout(function() {
                    ...
                    O[D] = "0px", P[D] = C, R[D] = L, I[D] = "0%", A[D] = k, Q[D] = C, M[D] = S, z[D] = j, T.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), s.add(punchgs.TweenLite.fromTo(r, f / 1e3, O, P), 0), s.add(punchgs.TweenLite.fromTo(n.find(".defaultimg"), f / 2e3, R, I), f / 2e3), s.add(punchgs.TweenLite.fromTo(T, f / 1e3, A, Q), 0), s.add(punchgs.TweenLite.fromTo(T.find(".slotslide div"), f / 1e3, M, z), 0)
                }
